...
namespace SeleniumProject.PageObjects
{
    partial class HomePage
    {
        ...
        private IWebElement homeButton => _driver.FindElement(By.XPath("/html/body/div/div[2]/div/div[1]/a[1]"));
        private IWebElement shortSleeveShirtButton => _driver.FindElement(By.XPath("/html/body/div/div[2]/div/div[2]/div/div[1]/ul[1]/li[1]/div/div[1]/div/a[1]/img"));
